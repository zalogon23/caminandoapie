  ...
  if (linkbox) {
    return (
      <LinkBox as="article" w={w} maxW={maxW} mx="auto" rounded="md" bg="orange.500" p="2">
        <Box rounded="lg" bg="white" display="flex" px="0" flexDir="column" height="100%" alignItems="center" pb="8">
          ...
          <Text w="100%" color="gray.400" py="10" px="4" fontSize={fontSizes.paragraph}>{content}</Text>
